      ...
      <section className="bg-[#1B3A5C] text-white py-16 px-4" aria-label="Hero">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-4">
            Exterminator Near Me — NYC &amp; Long Island
          </h1>
          <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">
            Licensed exterminators serving all of NYC and Long Island. Local technicians, fast response, guaranteed results.
          </p>
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-6">
            {REGIONS.map(region => (
              <div key={region.slug} className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                ...
                <Link
                  href={`/${region.slug}/exterminator-near-me/`}
